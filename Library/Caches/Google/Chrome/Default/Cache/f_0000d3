...
}}var e={global:"https://ssl.apple.com"+h+"/search/",ipad:"https://ssl.apple.com"+h+"/search/",iphone:"https://ssl.apple.com"+h+"/search/",ipoditunes:"https://ssl.apple.com"+h+"/search/",mac:"https://ssl.apple.com"+h+"/search/",store:"https://ssl.apple.com"+h+"/search/",support:"http://www.info.apple.com/searchredir.html"};
if(typeof(window.searchHost)!=="undefined"&&window.searchHost===true){var g=window.location.protocol+"//"+window.location.hostname;
if(searchSection!=="support"){var f=e[searchSection].replace("https://ssl.apple.com",g)
}}else{var f=e[searchSection]||"https://ssl.apple.com/search/"}this.globalSearchForm.setAttribute("action",f);
...
if(typeof(window.searchHost)!=="undefined"&&window.searchHost===true){n.href=decodeURIComponent(this.data.url).replace("https://ssl.apple.com",r)
...
return this};SearchShortcut.quickLinks=function(){this.baseShortcutsUrl="https://ssl.apple.com/global/nav/scripts/shortcuts.php"
...
this.aiGetSuggestionsUrl=c+"/search/instant/getSuggestions"}else{this.aiGetSuggestionsUrl="https://ssl.apple.com/search/instant/getSuggestions"
