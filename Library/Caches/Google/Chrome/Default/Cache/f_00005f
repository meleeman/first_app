...
t&&(this.adamId=t.getAttribute("adam-id"))}function ITSPlayVideoController(e){this.init(e)}function dbg(e){}function info(e){}function detectAndOpenItunes(e){if(-1<navigator.userAgent.indexOf("iPhone")||-1<navigator.userAgent.indexOf("iPod")&&-1<window.location.href.indexOf("ign-iphone")){e=window.location.href;
var t="ign-iphone=1";
if(!e.indexOf(t)){var n=e.indexOf("?")===-1?"?":"&";
e+=n+t}return window.location.href!=e&&setTimeout(function(){window.location.href=e},1),!1}var r=its.detect.itunesDetected(),i=its.detect.shouldAutolaunch();
return itms.PageData.itunesDetectedCallback(r,i),r&&i?its.detect.openItunes(e):!0}function detectAndOpenMacAppStore(e){var t=its.detect.macAppStoreDetected(),n=its.detect.shouldAutolaunch();
...
return r.prototype.initialize||(r.prototype.initialize=its.emptyFunction),r.prototype.constructor=r,r.klassName=e,r},extend:function(e,t){for(var n in t)e[n]=t[n];
...
return i},its.x.element.getAttributeValuesOfChildren=function(t,n){var r=[];
for(var i=0;
i<t.children.length;
...
n>0&&(t+="&"),t+=r+="="+encodeURIComponent(i),n++}return its.string.xmlEscape(t)},ITSMetrics.omniturePageName=function(){return ITSMetrics.omniture&&ITSMetrics.omniture.pageName?ITSMetrics.omniture.pageName:null},ITSMetrics.omnitureChannel=function(){return ITSMetrics.omniture&&ITSMetrics.omniture.channel?ITSMetrics.omniture.channel:null},ITSMetrics.processQueryParameterInfoInCurrentRequest=function(e){var t=its.url.queryParamsDict();
...
if(u>1){jQuery(a).css({width:this.content.width+"px"}).addClass("image-wrapper");
if(!i){r(this.container);
var f={orientation:"horizontal",track_wrapper:jQuery("#scroller_"+n),track_well:"null",track_well_cap:"null",track_thumb:jQuery(".scroll",this.container),track_thumb_cap:jQuery(".scroll_cap",this.container),content_wrapper:this.container,content:jQuery(".image-wrapper",this.container)};
jQuery(this.container).is_scrollable(f)}}else a.style.width="auto"}},o=function(e,n){this.position_images=function(t){var n=0,r;
...
return this.each(function(e,t){r=new s(t,e)})}}(),jQuery(window).load(function(){jQuery(".screenshots .content").AppGallery({content:"div:first",image_wrapper:".lockup"})}),function(){jQuery.fn.Pill=function(e){var t={toggleDiv:"div.screenshots div.content",toggleButtons:"div.screenshots div.pill a"};
e&&jQuery.extend(t,e);
var n,r=function(e){jQuery(e).each(function(e,n){e<1&&(jQuery(n).addClass("first active"),i(),jQuery(document.body).hasClass("social-preview")&&twttr.remote.ui("resizeFrame",jQuery(document.body).height())),jQuery(n).click(function(e){e.preventDefault(),e.stopPropagation();
if(!jQuery(this).hasClass("active")){var n=jQuery(this);
jQuery(t.toggleDiv).each(function(){jQuery(this).toggle()}),jQuery(t.toggleButtons).each(function(){jQuery(this).removeClass("active")}),jQuery(this).addClass("active")}})})},i=function(){jQuery(t.toggleDiv).each(function(e,t){e>0&&jQuery(t).addClass("ipad")})};
...
var n=its.detect.currentPageIsMacAppStore()||its.url.queryParamValue("mt",t)=="12",r=n?its.detect.macAppStoreDetected():its.detect.itunesDetected();
if(r){t=t.replace(/^http/,n?"macappstore":"itms");
var i=t.indexOf("#");
i>-1&&(t=t.substring(0,i));
if(t.indexOf("payPalMIPReturn")===-1&&t.indexOf("firstGateReturn")===-1&&t.indexOf("payclickSignUpReturn")===-1&&t.indexOf("payclickBillingReturn")===-1){var s=t.indexOf("?")===-1?"?":"&",o=its.cookies.get("a");
o&&(t+=s+"affC="+its.detect.encodedQueryParameter(o),s="&");
if(document.referrer){var u=its.detect.encodedQueryParameter(document.referrer);
t.length+u.length<400&&(dbg("openItunes: Attaching "+document.referrer),t+=s+"ign-msr="+u)}}}else t=itms.PageData.itunesDownloadUrl;
return dbg("openItunes: "+t),window.location.href!=t&&(setTimeout(function(){window.location.href=t},1),n&&setTimeout(function(){window.location.href=t},2e3)),!1},its.detect.encodedQueryParameter=function(t){var n=encodeURIComponent(t);
return its.x.isIE()&&(n=encodeURIComponent(n)),n};
var deviceDetect=function(){var e=navigator.userAgent;
switch(!0){case-1!=e.indexOf("iPhone"):setViewport("iphone"),setTouchEvents(),jQuery("html").addClass("iphone"),jQuery("body").addClass("iphone");
...
jQuery("head").append(t),window.addEventListener("load",function(){setTimeout(function(){window.scrollTo(0,1)},0)})}},itms=function(){return{replaceClass:function(e,t,n){return n||(n=""),dbg("Replacing "+t+" with "+n),e.className=e.className.replace(t,n),!1},PageData:{itunesDetectedCallback:function(e,t){e?(t?document.getElementsByTagName("body")[0].className+=" launching-itunes":document.getElementsByTagName("body")[0].className+=" no-action",setTimeout(function(){var e=document.getElementsByTagName("body")[0].className;
...
for(i=0;
i<t.length;
i++)t[i].className=="spinner"&&(t[i].className="no-spinner")},1e4),document.getElementsByTagName("body")[0].className+=" itunes-detected"):document.getElementsByTagName("body")[0].className+=" itunes-not-detected"},itunesDownloadUrl:"http://apple.com/itunes/download",itunesDetectorElement:document.getElementById("iTunesDetectorIE"),macAppStoreDetectedCallback:function(e,t){e?document.getElementsByTagName("body")[0].className+=" mac-app-store-detected":document.getElementsByTagName("body")[0].className+=" mac-app-store-not-detected"},macAppStoreDownloadUrl:"http://www.apple.com/mac/app-store/"}}}(),Tracklist={toHover:"div.track-list tbody tr",url:null,isSocial:null,init:function(){this.url=this.getURL(),this.isSocial=document.body.className.match(/song/);
...
if(n)return n[1]},elementsInit:function(){if(this.elements&&this.elements.length>0){var e=this.elements;
if(this.url)var t=!1;
else var t=!0;
var n=this;
acme.forEach(e,function(e){var r=n.previousRow(e);
!t&&e.getAttribute("adam-id")==n.url&&(e.className=e.className+" selected",t=!0,n.isSocial==null&&its.x.addEventListener(e,"mouseout",function(){return this.className=this.className.replace("selected",""),!1})),its.x.addEventListener(e,"mouseover",function(e){return r&&(r.className=r.className+" borderless"),!1}),its.x.addEventListener(e,"mouseout",function(e){return r&&(r.className=r.className.replace("borderless","")),!1})})}},previousRow:function(e){if(e){p=e;
...
Tracklist.domready(),function(e){var t=54;
e.fn.willTruncate=function(n){var r=t;
n>0&&(r=n);
var i,s,o,u;
return this.each(function(){i=e(this),i.height()>r&&(s=i.parent(),o=s.attr("more-text")||iTSLocalization?iTSLocalization.localize("Js.TextTruncation.More"):"More",i.addClass("truncate").css({height:r+"px"}),s.append('<a href="#" class="more-link">...'+o+"</a>"),u=i.siblings("a.more-link"),u.click(function(){return jQuery(this).siblings(".truncate").removeClass("truncate").css({height:"auto"}),e(this).remove(),jQuery(document.body).hasClass("social-preview")&&twttr.remote.ui("resizeFrame",jQuery(document.body).height()),!1}))})}}(jQuery),jQuery(document).ready(function(){if(!!window.location.hash.match(/fullText/))return;var e=jQuery("[will-truncate-max-height]");
e.willTruncate(e.attr("will-truncate-max-height"))}),function(e){e.fn.TVRating=function(){return this.each(function(){var e=jQuery(this),t=e.attr("rating-id"),n=e.attr("rating-system"),r=n+"-"+t;
